...
func (b *Block) Solve(address Address, reward int64, difficulty int) bool {
	b.addCoinbaseTx(address, reward)
...
func (b *Block) addCoinbaseTx(address Address, reward int64) {
	t := NewTx(Address{}, address, reward)
